package com.harmonyit.assessments.gamehouse.userservice.api.impl;
...
import com.harmonyit.assessments.gamehouse.api.service.user.UserServiceProxy;
...
class UserServiceRestImpl implements UserServiceProxy {
	...
	/* (non-Javadoc)
	 * @see com.harmonyit.assessments.gamehouse.api.service.user.UserServiceProxy#getUser(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.harmonyit.assessments.gamehouse.api.service.user.UserServiceProxy#getTotalUsers()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.harmonyit.assessments.gamehouse.api.service.user.UserServiceProxy#addUser(com.harmonyit.assessments.gamehouse.domain.User)
	 */
	@Override
